      ...
      <div className="max-w-4xl mx-auto p-6">
        ...
        <div className="space-y-6">
          {notifications.map(notification => (
            ...
            >
              <div className={`w-14 h-14 flex justify-center items-center rounded-full ${notification.type === 'like' ? 'bg-yellow-400' : notification.type === 'comment' ? 'bg-green-400' : 'bg-purple-400'}`}>
