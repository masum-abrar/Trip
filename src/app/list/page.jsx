  ...
  const sections = [
    {
        ...
        spots: [
          { 
            id: 1, 
            name: "Nilgiri Hills", 
            image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRltGRoSqSjk5aJz4fNvFp5l0MgYdLjoBsnfA&s",
            location: "Bandarban"
          },
          { 
            id: 2, 
...
,      
{
  ...
  <Slider {...settings}>
    {section.spots.map((spot) => (
      <div 
        key={spot.id}
        className="group relative overflow-hidden rounded-xl aspect-[4/3] transform hover:scale-105 transition-all duration-300 shadow-lg " // Added mx-2 for gap between cards
      >
