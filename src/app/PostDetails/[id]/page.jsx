  ...
  useEffect(() => {
    const fetchPost = async () => {
      try {
        ...
        if (
          userId &&
          data.data?.likes?.some((like) => like.userId === userId)
        ) {
          setLiked(true);
        }
      } catch (error) {
                  ...
                  <div className="flex gap-2 items-start">
                    ...
                    <div className="flex-1">
                      ...
                      {activeReplyInput === comment.id && (
                        <div className="flex items-center gap-2 mt-2 ml-2">
                          ...
                          <button
                            ...
                            disabled={loading || !userId}
                            // disabled={loading}
                            className="bg-[#8cc163] text-white px-3 py-1 rounded-md text-sm disabled:opacity-50"
                          >
                      ...
                      {comment.reply?.map((reply) => (
                        <div
                          key={reply.id}
                          className="flex gap-2 items-start mt-3 ml-4"
                        >
