...
function Communities() {
  ...
  <Link href={`/district/${section.district}`}>
    <h2 className="relative text-2xl lg:text-3xl font-semibold text-gray-800 tracking-wide text-center 
                   before:absolute before:inset-x-0 before:bottom-0 before:h-[3px] before:bg-[#8cc163] 
...
{/* Comments Section */}
<div className="mt-6 max-w-6xl bg-white p-4 ">
